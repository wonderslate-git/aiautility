...
import com.ws.android.playground.aiaimpl.todoapp.Injection;
import com.ws.android.playground.aiaimpl.todoapp.addedittask.AddEditTaskViewModel;
import com.ws.android.playground.aiaimpl.todoapp.appinappsample.AppInAppViewModel;
import com.ws.android.playground.aiaimpl.todoapp.data.source.TasksRepository;
import com.ws.android.playground.aiaimpl.todoapp.statistics.StatisticsViewModel;
import com.ws.android.playground.aiaimpl.todoapp.taskdetail.TaskDetailViewModel;
import com.ws.android.playground.aiaimpl.todoapp.tasks.TasksViewModel;
...
public class ViewModelFactory extends ViewModelProvider.NewInstanceFactory {
    ...
    public <T extends ViewModel> T create(Class<T> modelClass) {
        ...
        else if (modelClass.isAssignableFrom(AppInAppViewModel.class)) {
            //noinspection unchecked
            return (T) new AddEditTaskViewModel(mTasksRepository);
        }
