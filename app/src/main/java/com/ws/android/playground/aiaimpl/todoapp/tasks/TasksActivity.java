...
package com.ws.android.playground.aiaimpl.todoapp.tasks;

import android.content.Intent;
import android.os.Bundle;
import android.view.MenuItem;

import com.ws.android.playground.aiaimpl.todoapp.Event;
import com.ws.android.playground.aiaimpl.todoapp.R;
import com.ws.android.playground.aiaimpl.todoapp.ViewModelFactory;
import com.ws.android.playground.aiaimpl.todoapp.addedittask.AddEditTaskActivity;
import com.ws.android.playground.aiaimpl.todoapp.appinappsample.AppInAppActivity;
import com.ws.android.playground.aiaimpl.todoapp.statistics.StatisticsActivity;
import com.ws.android.playground.aiaimpl.todoapp.taskdetail.TaskDetailActivity;
import com.ws.android.playground.aiaimpl.todoapp.util.ActivityUtils;
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.statistics_navigation_menu_item:
                                ...
                                break;
                            case R.id.appinapp_navigation_menu_item:
                                Intent appInAppIntent =
                                        new Intent(TasksActivity.this, AppInAppActivity.class);
                                startActivity(appInAppIntent);
                            default:
                                break;
                        }
